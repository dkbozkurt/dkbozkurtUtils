...
namespace DKBozkurt.Attributes
{
    ...
    public class ShowIfAttributeTest : MonoBehaviour
    {
        ...
        [Space]
        /// <summary>
        /// Using multiple conditions on the same field for and.
        /// </summary>
        ...
        [Space] 
        /// <summary>
        /// Using multiple conditions on the same field for or.
        /// </summary>
        public bool orCondition1;
        public bool orCondition2;
        [ShowIf(ActionOnConditionFail.JustDisable,ConditionOperator.Or,
            nameof(orCondition1),nameof(orCondition2))] 
        public string orField = "Or field text";
